package com.booklibrary.exception.handler;
...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    /**
     * Handles DuplicateEntityException. Created to encapsulate errors for multiple entities.
     *
     * @param ex the DuplicateEntityException
     * @return the ApiError object
     */
    @ExceptionHandler(DuplicateEntityException.class)
    protected ResponseEntity<Object> handleDuplicateEntityFound(
